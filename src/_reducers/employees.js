...
import { EMPLOYEES_ENTITY } from "../_store/entities";
...
const handler = {
	...
	[FETCH_SUCCESS]: (state, action) => {
		...
		if (entity === EMPLOYEES_ENTITY && Array.isArray(data)) {
			return fetchSuccessHandler(state, listById(data));
		}
